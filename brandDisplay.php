...
if(isset($_POST['submit'])){ 	
  ...
  $sql="SELECT * FROM product LEFT JOIN category ON product.category_id = category.shoes_id where category_id='$id'";
          ...
          <div class="row align-items-stretch">
            ...
            <div class="col-md-3 ml-auto" data-aos="fade-up" data-aos-delay="100">
              <div class="sticky-content">
                ...
                <p class="mb-4"><span class="text-muted"><?php echo $shoes_type?></span></p>

            <div class="mb-5">
              <p>100% authentic of <b> <?php echo $brand;?> </b> shoes and quality guaranteed!</p>
            </div>

                <h4 class="h4 mb-3">Further Details</h4>
